      ...
      return (
        <div className="space-y-4">
          {question.options.map((option, idx) => (
            ...
            >
              <span className="flex items-center justify-center h-8 w-8 rounded-full border-2 border-gray-400 text-gray-600 font-semibold text-sm mr-4">{String.fromCharCode(65 + idx)}</span>
